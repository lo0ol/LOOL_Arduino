 ...
 * \class   LOOL_Gyro
 * \brief   Driver for LOOL_Gyro module.
 * @file    LOOL_Gyro.h
 * @author  MakeBlock
 * @version V1.0.0
 * @date    2015/09/01
 * @brief   Header for LOOL_Gyro.cpp module.
 *
 * \par Copyright
 ...
 *
 * \par Description
 * This file is a drive for LOOL_Gyro module, It supports LOOL_Gyro V1.0 device provided
 * by MakeBlock.
 *
 * \par Method List:
 *
