 ...
 * \class   LOOL_Compass
 * \brief   Driver for LOOL_Compass module.
 * @file    LOOL_Compass.h
 * @author  MakeBlock
 * @version V1.0.0
 * @date    2015/09/01
 * @brief   Header for LOOL_Compass.cpp module.
 *
 * \par Copyright
 ...
 *
 * \par Description
 * This file is a drive for LOOL_Compass module, It supports LOOL_Compass V1.0 device provided
 * by MakeBlock.
 *
 * \par Method List:
 *
